            ...
            <div className="pt-4">
              ...
              <div className="space-y-3 font-semibold text-stone-700 text-sm">
                <div 
                  ...
                  className="flex items-center gap-3.5 p-3 border-2 border-black rounded-lg bg-stone-50 cursor-pointer hover:bg-stone-100 hover:translate-y-[-1px] transition-all shadow-[2px_2px_0px_#000]"
                >
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-xs sm:text-sm truncate">m3hi13245@gmail.com</div>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-xs sm:text-sm">8168341986</div>
                  </div>
                </div>
              </div>
            </div>
